...
int main(int argc, char **argv)
{
    ...
    int kernel_type = STARSH_SPATIAL_SPACE_TIME_SIMD;
    // Correlation length
    double beta = 0.23;
    ...
    double beta_time = 1;
    // Smoothing parameter for Matern kernel in time
    double nu_time = 0.5;
    // nonsep param
    double nonsep_param = 0.5;
    // aux param
    double aux_param = 0;
    ...
    info = starsh_application((void **)&data, &kernel, N, dtype,
             ...
             STARSH_SPATIAL_BETA, beta,
             STARSH_SPATIAL_NU, nu,
             STARSH_SPATIAL_NOISE, noise,
             STARSH_SPATIAL_PLACE, STARSH_PARTICLES_OBSOLETE5, //1,
             STARSH_SPATIAL_SIGMA, 1,
             STARSH_SPATIAL_BETA_TIME, beta_time,
             STARSH_SPATIAL_NU_TIME, nu_time,
             STARSH_SPATIAL_NONSEP_PARAM, nonsep_param,
             STARSH_SPATIAL_AUX_PARAM, aux_param,
             STARSH_SPATIAL_SPACE_TIME_SLOTS, time_slots,
             0);
